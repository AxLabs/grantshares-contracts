...
public class RequestForFunds {
     ...
     *
     * @param token         the token hash to be bridged
     ...
     */
    public static byte[] buildIntentsBytes(
            Hash160 token,
            Hash160 treasury,
            Hash160 bridgeAdapter,
            Hash160 recipient,
            BigInteger amount,
    ...
    private static void pushReleaseTokensIntent(
            ScriptBuilder b,
            Hash160 token,
            Hash160 treasury,
            Hash160 to,
        ...
        b.pushParam(hash160(treasury));

        b.pushInteger(4);
        b.pack();
    }

    private static void pushAdapterBridgeIntent(
            ScriptBuilder b,
            Hash160 token,
            Hash160 bridgeAdapter,
            Hash160 recipient,
        ...
        // Replicate array(bridgeAdapter, "bridge", [token, to, amount], CallFlags.ALL)
        b.pushParam(integer(CallFlags.ALL.getValue()));
        ...
        b.pushParam(hash160(bridgeAdapter));
